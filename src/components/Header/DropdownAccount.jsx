...
const DropdownAccount = () => {
    ...
    const handleLogout = async () => {
        try {
            // Gọi API logout từ server để xóa refreshToken
            await userService.Logout();
            // Xóa accessToken từ local storage
            localStorage.removeItem('accessToken');
            // Reset state của user trong Redux store
            dispatch(resetUser());

            // Xóa accessToken từ default headers của axios
